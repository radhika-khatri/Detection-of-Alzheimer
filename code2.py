...
# Predict and evaluate the Logistic Regression model on the test set
...
print("Logistic Regression - Precision: %.2f" % precision)
print("Logistic Regression - Recall: %.2f" % recall)
