...
# Predict and evaluate the Naive Bayes model on the test set
...
print("Naive Bayes - Accuracy: %.2f" % acc)
print("Naive Bayes - F1 Score: %.2f" % f1)
print("Naive Bayes - Precision: %.2f" % precision)
print("Naive Bayes - Recall: %.2f" % recall)
